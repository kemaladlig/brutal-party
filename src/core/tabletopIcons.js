...
const LUCIDE_REGISTRY = {
  ...
  // HORDE cephane bittiğinde "neden ateş etmiyorsun" sorusunu yanıtlar. Yalnız
  // bir halka çizmek belirsizdi ("cooldown mu, shield mı, ölü mü?"); metin rozeti
  // ile birlikte kullanılınca anlam kazanıyor.
  reload: {
    id: 'reload',
  ...
  arrow_up: {
    id: 'arrow-up',
    aliases: ['▲', 'steer_up', 'arrow_up', 'arrow-up', 'up'],
    path: 'M12 19l-7-7 7-7 M19 12H5',
    mode: 'stroke',
    strokeWidth: 2.6,
  },
  arrow_down: {
    id: 'arrow-down',
    aliases: ['▼', 'steer_down', 'arrow_down', 'arrow-down', 'down'],
    path: 'M12 5l7 7-7 7 M5 12h14',
    mode: 'stroke',
    strokeWidth: 2.6,
  },
  ...
  hourglass: {
    id: 'hourglass',
    aliases: ['⏳', 'hourglass', 'wait'],
    path: 'M5 22h14 M5 2h14 M17 22v-4.172a2 2 0 0 0-.586-1.414L12 12l-4.414 4.414A2 2 0 0 0 7 17.828V22 M7 2v4.172a2 2 0 0 0 .586 1.414L12 12l4.414-4.414A2 2 0 0 0 17 6.172V2',
    mode: 'stroke',
  },
  timer: {
    id: 'timer',
    aliases: ['⏱', 'timer', 'stopwatch'],
    path: 'M10 2h4 M12 14l3-3 M12 21a9 9 0 1 1 0-18 9 9 0 0 1 0 18z',
    mode: 'stroke',
  },
  armchair: {
    id: 'armchair',
    aliases: ['💺', 'seat', 'armchair'],
  ...
  door_closed: {
    id: 'door-closed',
    aliases: ['🚪', 'door', 'door_closed', 'door-closed', 'exit_door'],
    path: 'M18 20V6a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v14 M2 20h20 M14 12v.01',
    mode: 'stroke',
  },
  palette: {
    id: 'palette',
    aliases: ['🎨', 'palette', 'art'],
    path: 'M12 22a10 10 0 1 1 10-10c0 4.9-3.5 4-5.5 4-1.3 0-2.5 1-2.5 2.5S13.4 22 12 22z M13.5 6.5h.01 M17.5 10.5h.01 M8.5 7.5h.01 M6.5 12.5h.01',
    mode: 'stroke',
  },
  footprints: {
    id: 'footprints',
    aliases: ['🏃', 'run', 'footprints'],
