...
- [x] **HUD, Staging Bar ve İfade İkonları Vektörleşti:** staging bar ve in-game HUD butonlarındaki emojiler (`data-icon` / `data-lobby-icon`) `hydrateIconSlots` ile SVG'ye bağlandı. `AVATAR_EXPRESSIONS` ve i18n anahtarlarındaki ham emojiler temizlendi.
